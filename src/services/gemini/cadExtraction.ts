...
5. Do NOT repeat the same detail (for the same item or for different item), Each detail should belong to ONE item ONLY. If a detail is duplicated, return it only once.
